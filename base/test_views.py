...
class TestBaseViews(StaticLiveServerTestCase):
    ...
    def test_home(self):
        ...
        """
        self.browser.visit(self.live_server_url + reverse('base:home'))
        self.assertTrue(self.browser.is_text_present('puntos'))
    ...
    def test_robots(self):
        ...
        """
        self.browser.visit(self.live_server_url + reverse('base:base_files',
    ...
    def test_api_docs(self):
        """Test for url 'base:api_docs'.

        Visit the url of the API documentation and check it loads properly
        """
        self.browser.visit(self.live_server_url + reverse('base:api_docs'))
        self.assertTrue(self.browser.is_text_present('iuPick API'))
