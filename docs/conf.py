...
# -*- coding: utf-8 -*-
#
# django_template documentation build configuration file, created by
# sphinx-quickstart on Sun Mar  5 12:31:14 2017.
#
...
latex_documents = [
    (master_doc, 'iuPick.tex', 'django\\_template Documentation',
     '{[}tosp{]}', 'manual'),
]
...
man_pages = [
    (master_doc, 'iuPick', 'iuPick Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'iuPick', 'iuPick Documentation',
     author, 'iuPick', 'Boilerplate for future iupick projects.',
     'Miscellaneous'),
]
